...
extern void shannon_pci_reset_prepare(struct pci_dev *pdev);
extern void shannon_pci_reset_finished(struct pci_dev *pdev);
extern void shannon_pci_reset_notify(struct pci_dev *pdev, bool prepare);
...
extern int check_has_dma_delay(void);
